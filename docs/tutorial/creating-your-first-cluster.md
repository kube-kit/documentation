...
Creating a cluster in **KubeKit** is simple, fast, and effortless. Follow these steps to set up your first Kubernetes cluster. See the [prerequisites](/docs/cluster/creation/prerequisites.md) first.
...
![](../images/final/node-configuration.png)
